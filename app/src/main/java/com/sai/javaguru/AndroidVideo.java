...
public class AndroidVideo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mediaControls == null) {
            mediaControls = new MediaController(AndroidVideo.this);
        }
        ...
        progressDialog = new ProgressDialog(AndroidVideo.this);
        ...
        try {
            ...
            myVideoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.classes));
